...
import { PendingApprovalsView } from '../listing-screen/components/PendingApprovalsView';
...
export interface ListingContentProps {
  ...
  onPendingApprovalsCountChange?: (count: number) => void;
}
    ...
    >
      ...
      {activeTab === 'listing' && (
        <ListingSectionContent
          ...
          onPendingApprovalsCountChange={onPendingApprovalsCountChange}
        />
      )}
...
function ListingSectionContent({
  ...
  return (
    <div className="h-full">
      {sectionTab === 'pending-approvals' && (
        <PendingApprovalsView onCountChange={onPendingApprovalsCountChange} />
      )}
      ...
      {sectionTab !== 'listing' && sectionTab !== 'growth' && sectionTab !== 'pending-approvals' && (
        <div className="space-y-6 p-6">
          <ViewListingProducts section={sectionTab} />
        </div>
      )}
